...
[assembly: OwinStartup(typeof(WebThoitrang.Web.App_Start.Startup))]

namespace WebThoitrang.Web.App_Start
{
    public partial class Startup
    {
        ...
        public void ConfigureAuth(IAppBuilder app)
        {
            ...
            app.CreatePerOwinContext(WebThoitrangDbContext.Create);
        ...
        {
            var userStore = new UserStore<ApplicationUser>(context.Get<WebThoitrangDbContext>());
